...
val bannedItems = [<MineFactoryReloaded:machine.2:2>, <WitchingGadgets:item.WG_Bag:3>, <arsmagica2:arcaneDeconstructor>, <Mekanism:BasicBlock2:1>, <Mekanism:BasicBlock2:2>, <Mekanism:BasicBlock2:3>, <Mekanism:BasicBlock2:4>, <Mekanism:MachineBlock:15>] as IItemStack[];
